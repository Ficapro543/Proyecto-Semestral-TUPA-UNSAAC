...
El equipo de desarrollo está conformado por \textbf{2 a 3 estudiantes} de la
...
\begin{ganttchart}[
    ...
    bar/.style={fill=unsaacRojo!70},
    bar incomplete/.style={fill=unsaacGris!40},
    milestone/.style={fill=unsaacRojo, shape=diamond, inner sep=1.5pt},
    today=10,
    today rule/.style={draw=unsaacRojo, ultra thick},
    title height=1
  ]{1}{22}
  \gantttitle{Mayo}{2}
  \gantttitle{Junio}{9}

...
El proyecto se organiza en \textbf{cinco sprints} de dos semanas cada uno,
iniciando con el \textit{Sprint 0} el \textbf{martes 19 de mayo}, y se alinea con
las dos entregas formales del semestre, tal como se describe en la sección de
metodología. El Sprint 0 comprende el análisis del TUPA vigente, el levantamiento
de requerimientos, la elaboración del plan de proyecto y el prototipado dinámico,
culminando con el \textbf{primer entregable} el \textbf{28 de mayo de 2026}.
...
%--- Encabezados ---
\gantttitle{Semestre 2026-I (10 semanas)}{10} \\
\gantttitle{Mayo}{2}\gantttitle{Junio}{4}\gantttitle{Julio}{4} \\
...
%--- Sprint 1 ---
\ganttgroup{Sprint 1 --- Módulo de Consulta TUPA}{3}{4} \\
\ganttbar{Implementación de consulta de procedimientos}{3}{4} \\
\ganttbar{Autenticación y gestión de usuarios}{3}{4} \\
\ganttbar{Layout base y diseño responsivo}{3}{4} \\
\ganttbar{Configuración de BD y migraciones}{3}{3} \\
\ganttbar{Pruebas unitarias del módulo}{4}{4} \\[grid]

%--- Sprint 2 ---
\ganttgroup{Sprint 2 --- Registro y Seguimiento}{5}{6} \\
\ganttbar{Formulario de registro de trámite}{5}{6} \\
\ganttbar{Seguimiento de expedientes}{5}{6} \\
\ganttbar{Sistema de notificaciones}{6}{6} \\
\ganttbar{Validación de documentos}{6}{6} \\[grid]

%--- Sprint 3 ---
\ganttgroup{Sprint 3 --- Panel Administrativo}{7}{8} \\
\ganttbar{Panel de control administrativo}{7}{8} \\
\ganttbar{Módulo de reportes y estadísticas}{7}{8} \\
\ganttbar{Mejoras de accesibilidad}{8}{8} \\[grid]

%--- Sprint 4 ---
\ganttgroup{Sprint 4 --- Integración y Cierre}{9}{10} \\
\ganttbar{Integración de módulos}{9}{10} \\
\ganttbar{Corrección de defectos}{9}{10} \\
\ganttbar{Pruebas de regresión}{10}{10} \\
\ganttbar{Documentación técnica}{10}{10} \\
\ganttbar{Despliegue en la nube}{10}{10} \\
\ganttmilestone{Entrega 2 (1.${}^{\circ}$ sem. agosto)}{10}
\end{ganttchart}
\end{figure}
...
largo de los cinco sprints del proyecto. Los costos se agrupan en cinco categorías:
...
\begin{tabular}{C{0.6cm} L{7.0cm} C{2.0cm} C{1.8cm} R{2.6cm}}
\toprule
\rowcolor{unsaacRed}
...
2 & Computadoras portátiles (costo de uso semestral, 4 unid.)
    & Global & 4 & \num{800,00} \\
3 & Servidor de desarrollo (VPS, 3 meses)
    & Mes & 3 & \num{90,00} \\
...
2 horas diarias, 3 días por semana (martes, jueves y sábado), para un total de
320 horas totales (80 horas por integrante). El equipamiento (B) considera el
...
asciende a \textbf{S/.\,\num{7737,25}}, financiado íntegramente por los
